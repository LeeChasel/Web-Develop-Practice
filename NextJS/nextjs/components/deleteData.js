...
function DeleteData({isOpen, setIsOpen, id})
{
    ...
    <Dialog.Panel className="w-1/3 rounded bg-sky-300 py-10 px-7">
      ...
      <div className="relative">
          <button onClick={handleDelete} className="bg-red-300 rounded-full hover:bg-red-400 active:bg-red-500 left-0 w-5/12 absolute">Sure to delete</button>
